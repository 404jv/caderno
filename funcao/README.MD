...
char procurar_letra_f(int palavra[]);
...
🎉E VOILÁ! Lindo demais, neh? Terminamos essa função, espero que você use essas dicas para deixar suas funções mais performáticas e mais legibilidade. 
